              ...
              render={arrayHelpers => (
                <div className={'flex flex-row space-x-10'}>
                  <div className='block flex-auto'>
                    <span className='text-black'>Available Contacts</span>
                    <div className={'overflow-y-auto overflow-x-visible h-24'}>
                      {!usersLoaded && (
                        <div className={'flex flex-row'}>
                          <Loading />
                          <p className={'flex text-black justify-center mt-2 ml-4'}>
                            Loading Contacts...
                          </p>
                        </div>
                      )}
                      {usersLoaded && userDetailList && userDetailList.length > 0
                        ...
                        : usersLoaded && <p className={'text-black mt-2'}>No Contacts</p>}
                    </div>
                    <div className={'flex flew-row mt-2 center-items'}>
                      ...
                      />
                      <p className={'ml-2 text-black center-items'}>Add all contacts</p>
                    </div>
                    <span className='text-red-500'>
                  ...
                  <label className='block flex-auto '>
                    <span className='text-black'>Selected Contacts</span>
                    <div className={'overflow-y-auto overflow-x-visible w-auto h-24'}>
                      {values.users.length > 0 ? (
                        ...
                        <p className={'text-black  mt-2'}>No Contacts</p>
                      )}
                    </div>
                  </label>
                </div>
