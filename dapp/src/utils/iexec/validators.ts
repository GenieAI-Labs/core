...
export const stringSchema = () => string().strict().typeError('${path} should be a string');
...
export const addressSchema = () =>
  string()
    ...
    .test(
      ...
      value => isUndefined(value) || isAddressTest(value as string),
    );
...
export const addressOrEnsSchema = () =>
  string()
    ...
    .test(
      ...
      value => isUndefined(value) || isAddressTest(value as string) || isEnsTest(value as string),
    );
  ...
  string()
    ...
    .test(
      ...
      (value, { originalValue }) =>
        ...
        isAddressTest(value as string) ||
        isEnsTest(value as string),
    );
...
export const positiveIntegerStringSchema = () =>
  string().test(
    ...
    value => isUndefined(value) || isPositiveIntegerStringTest(value as string),
  );
...
export const positiveStrictIntegerStringSchema = () =>
  string().test(
    ...
    value =>
      isUndefined(value) ||
      (!isZeroStringTest(value as string) && isPositiveIntegerStringTest(value as string)),
  );
...
export const secretsSchema = () =>
  object().test(
    'is-valid-secret',
    ({ label }) => `${label} must be an object with numeric keys and string values`,
    value => {
